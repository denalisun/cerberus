...
static_assert(sizeof(GAT_Athena_IceTrap_C_ExecuteUbergraph_GAT_Athena_IceTrap) == 0x000088, "Wrong size on GAT_Athena_IceTrap_C_ExecuteUbergraph_GAT_Athena_IceTrap");
...
static_assert(offsetof(GAT_Athena_IceTrap_C_ExecuteUbergraph_GAT_Athena_IceTrap, CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue) == 0x000078, "Member 'GAT_Athena_IceTrap_C_ExecuteUbergraph_GAT_Athena_IceTrap::CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue' has a wrong offset!");
